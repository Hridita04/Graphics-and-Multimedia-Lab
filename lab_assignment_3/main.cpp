...
int main()
{
    ...
    // --------------------
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "0432320005101104", NULL, NULL);
    if (window == NULL)
    {
    ...
    float vertices[] = {
    // Triangle 1
     0.0f,  0.50f, 0.0f,   // Top tip
    -0.20f, 0.10f, 0.0f, // Left inner
     0.20f, 0.15f, 0.0f, // Right inner

    // Triangle 2
     -0.1f, 0.20f, 0.0f,  // Right inner
     0.50f, 0.20f, 0.0f,  // Right outer
     0.15f, -0.30f, 0.0f, // Bottom right inner

    // Triangle 3
     0.25f, -0.0f, 0.0f, // Bottom right inner
     0.35f, -0.50f, 0.0f, // Bottom right outer
     0.0f, -0.25f, 0.0f,   // Bottom center inner

    // Triangle 4
     0.3f, -0.01f, 0.0f,   // Bottom center inner
    -0.20f, -0.10f, 0.0f, // Bottom left outer
    -0.20f, -0.6f, 0.0f, // Bottom left inner

    // Triangle 5
    -0.20f, -0.20f, 0.0f, // Bottom left inner
    -0.50f, 0.15f, 0.0f,  // Left outer
    0.4f, 0.15f, 0.0f   // Left inner
};
    ...
    */
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glDrawArrays(GL_TRIANGLES, 0, 15); //0 starting index, 3 no. of vertices
